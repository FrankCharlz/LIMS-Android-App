 ...
 * <br><br>
 * 3) Consistency. Doing a write followed by a read should return the value you just write.
 * <br><br>
...
public class Remember {
     ...
     * 		the key
     * @param value
     * 		the value to write. This MUST be a type supported by SharedPreferences. Which is to say: one of (float,
